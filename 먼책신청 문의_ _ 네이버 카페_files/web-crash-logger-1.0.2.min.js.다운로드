...
},{"./../utils":"S1cf","./../core/settle":"aS8y","./../helpers/buildURL":"H6Qo","./../helpers/parseHeaders":"ZeD7","./../helpers/isURLSameOrigin":"w7LF","../core/createError":"bIiH","./../helpers/cookies":"dn2M"}],"IDzb":[function(require,module,exports) {
...
},{"./utils":"S1cf","./helpers/normalizeHeaderName":"M8l6","./adapters/http":"KRuG","./adapters/xhr":"KRuG","process":"IDzb"}],"YZjV":[function(require,module,exports) {
...
},{"./lib/axios":"nUiQ"}],"P8NW":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.CrashLoggerBuilder=void 0;var e=r(require("@babel/runtime/helpers/createClass")),t=r(require("@babel/runtime/helpers/classCallCheck"));function r(e){return e&&e.__esModule?e:{default:e}}var s=function(){console.error("[Crash-Logger] not supported method")},u=function e(){(0,t.default)(this,e),this.init=s,this.options={},this.captureEvent=s,this.captureMessage=s,this.captureException=s,this.setUser=s,this.setContext=s},i=function(){function r(){(0,t.default)(this,r),this.crashLogger=new u}return(0,e.default)(r,[{key:"useInit",value:function(e){return this.crashLogger.init=e,this}},{key:"useCaptureEvent",value:function(e){return this.crashLogger.captureEvent=e,this}},{key:"useCaptureMessage",value:function(e){return this.crashLogger.captureMessage=e,this}},{key:"useCaptureException",value:function(e){return this.crashLogger.captureException=e,this}},{key:"useSetUser",value:function(e){return this.crashLogger.setUser=e,this}},{key:"useSetContext",value:function(e){return this.setContext=e,this}},{key:"build",value:function(){return this.crashLogger}}]),r}();exports.CrashLoggerBuilder=i;var n=function e(){(0,t.default)(this,e)};
},{"@babel/runtime/helpers/createClass":"P8NW","@babel/runtime/helpers/classCallCheck":"fcMS"}],"JQMe":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=r(require("axios")),o=require("../type/CrashLogger");function r(e){return e&&e.__esModule?e:{default:e}}var s={},t=function(e){var o=e.host,r=e.projectName,t=e.projectVersion,u=e.os,c=e.browser,a=e.cafeApp,p=e.uuid;s.host=o,s.projectName=r,s.projectVersion=t,s.os=u,s.browser=c,s.cafeApp=a,s.uuid=p},u=function(o){e.default.post("".concat(location.protocol,"//").concat(s.host),{projectName:s.projectName,projectVersion:s.projectVersion,exceptions:"simple message logging",body:{message:o,user:s.user,uuid:s.uuid},host:s.host,url:"".concat(location.href),protocol:"".concat(location.protocol).slice(0,-1),user:s.user,cafeApp:s.cafeApp,browser:s.browser,PeerIP:s.peerIP,os:s.os})},c=function(e){s.user=e},a=(new o.CrashLoggerBuilder).useInit(t).useCaptureMessage(u).useSetUser(c).build();exports.default=a;
},{"axios":"dZBD","../type/CrashLogger":"n5QU"}],"Focm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=r(require("./simple/SimpleAxiosLogger"));function r(e){return e&&e.__esModule?e:{default:e}}window.cafe=window.cafe||{},window.cafe.crashLogger=e.default;var o=e.default;exports.default=o;
},{"./simple/SimpleAxiosLogger":"JQMe"}]},{},["Focm"], null)
