...
def get_rows_from_tree_jsonForm(tree, column_field):
    ...
    for root, levels in tree.items():
        ...
        for level_2_uuid, level_2_data in levels['Level_2'].items():
            ...
            # 중복 검사, 추출안된 None값, 비밀댓글 삭제.
            if level_2_comment not in seen_comments and level_2_comment != 'None' and level_2_comment != '':
                        ...
                        level_2_replies.append(
                            {
                                ...
                                column_field[
                                    16
                                ]: '{ "toxicity": 0.0, "severe_toxicity": 0.0, "obscene": 0.0, "identity_attack": 0.0, "insult": 0.0, "threat": 0.0, "sexual_explicit": 0.0 }',  # noqa: E501
                                column_field[17]: root_uuid,
                                column_field[18]: "ready_for_export",
                                column_field[19]: '{ "name": [ "_skip_labeling" ], "count": [ 2 ] }',  # noqa: E501
                                column_field[
                                    20
                                ]: '{ "name": [ "spam", "lang_mismatch", "pii", "not_appropriate", "hate_speech", "sexual_content", "quality", "toxicity", "humor", "creativity", "violence" ], "value": [ 0, 0, 0, 0, 0, 0, 0.5833333333333334, 0.08333333333333333, 0.08333333333333333, 0.4166666666666667, 0 ], "count": [ 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 ] }',  # noqa: E501
                            }
                        )
            ...
            rows.append(
                {
                    ...
                    column_field[6]: remove_emojis(root.split('_seperation_title_')[0] + root.split('_seperation_title_')[1]),  # noqa: E501 # 내용
